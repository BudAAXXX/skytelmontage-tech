(() => {
  ...
  const I18N = {
    cs: {
      ...
      approachIntro: "Práci organizujeme tak, aby plánování, přístup do výšky i dokumentace měly jasný postup. Objednatel vždy ví, kdo na stavbě zodpovídá za koordinaci a výslednou kvalitu.",
      approach1: "Příprava zakázky na základě dohodnutého rozsahu, včetně podmínek přístupu, způsobu provádění prací a požadované dokumentace.",
      approach2: "Krátká koordinační domluva před hlavními pracemi (telefonicky nebo na místě) pro potvrzení aktuálních podmínek a případných změn.",
      approach3: "Realizace s důrazem na bezpečný přístup, čisté vedení kabeláže a mechanicky správnou montáž všech prvků.",
      approach4: "Závěrečná kontrola provedené práce, strukturovaná fotodokumentace a stručný přehled případných otevřených bodů.",

      safetyTitle: "Bezpečnost a kvalifikace",
      safetyIntro: "Práce ve výškách na telekomunikačních konstrukcích spojuje rope-access techniky, použití OOPP proti pádu a elektro činnosti v jednom prostředí. Bezpečnostní pravidla a kvalifikace jsou standardní součástí práce, ne navíc přidaná administrativa.",
      safety1: "Elektro kvalifikace dle NV 194/2022 §6/§7, používaná jako základní rámec pro práci na napájených telekomunikačních zařízeních v rámci EU.",
      safety2: "Pravidelná školení pro práce ve výškách a PSAgA včetně záchranných postupů přizpůsobených stožárům a střešním konstrukcím.",
      safety3: "Interní postupy a evidence zahrnující hodnocení rizik, záchranné scénáře, kontroly OOPP a základní kontroly nářadí a vybavení.",
      safety4: "Dáváme přednost stabilním týmům, které jsou na sebe zvyklé, před neustálým střídáním posádek.",

      contactTitle: "Kontakt a spolupráce",
      contactIntro: "Pro spolupráci na projektech výstavby, modernizace nebo servisu prosím využijte přímý kontakt níže. Nejlépe fungujeme při jasně popsaném rozsahu, realistických termínech a dlouhodobé technické spolupráci.",
      contactBilling: "Fakturace probíhá přes české s.r.o. s registrací k DPH v EU. Smluvní model a dokumentace lze nastavit podle požadavků hlavních dodavatelů a operátorů.",
      contactRoleLine: "Patrik Budinský – majitel, jednatel a technický vedoucí",
    ...
    en: {
      ...
      approachIntro: "Our work is organised so that planning, access at height and documentation follow a clear structure. The client always knows who is responsible for coordination on site and for the final quality check.",
      approach1: "Project preparation based on the agreed scope, including site access, expected working methods and required documentation.",
      approach2: "Brief coordination call or on-site meeting before the main work to confirm current conditions and any changes.",
      approach3: "Execution with focus on safe access, tidy cable routing and mechanically correct assembly of all components.",
      approach4: "Final check of the work, structured photo documentation and a short summary of open points, if any.",

      safetyTitle: "Safety and qualification",
      safetyIntro: "Work at height on telecom structures combines rope-access techniques, use of PPE against falls and electrical work in one environment. Safety rules and qualification are treated as a standard part of the job.",
      safety1: "Electrical qualification according to NV 194/2022 §6/§7 (Czech standard), used as a reference for work on powered telecom equipment within the EU.",
      safety2: "Regular training for work at height and PSAgA, including rescue procedures adapted to tower and rooftop structures.",
      safety3: "Internal procedures and records covering risk assessment, rescue arrangements, inspection of PPE and basic checks of tools and equipment.",
      safety4: "Preference for stable crews that know each other’s routines instead of constantly changing teams.",

      contactTitle: "Contact & cooperation",
      contactIntro: "For cooperation on rollout, modernisation or service projects, please use the direct contact below. We work best with clear scopes, realistic schedules and long-term technical cooperation.",
      contactBilling: "Invoicing is carried out via a Czech limited company (s.r.o.) with EU VAT registration. Contract models and documentation can be aligned with the requirements of main contractors and network operators.",
      contactRoleLine: "Patrik Budinský – owner, managing director and technical lead",
    ...
    de: {
      ...
      approachIntro: "Unsere Einsätze werden so strukturiert, dass Planung, Höhenzugang und Dokumentation einem klaren Ablauf folgen. Der Auftraggeber weiß jederzeit, wer vor Ort für die Koordination und die Endkontrolle verantwortlich ist.",
      approach1: "Projektvorbereitung auf Basis des abgestimmten Leistungsumfangs, einschließlich Zugangsbedingungen, geplanter Arbeitsweise und benötigter Dokumentation.",
      approach2: "Kurze Abstimmung vor Beginn der Hauptarbeiten (Telefonat oder Besprechung vor Ort), um aktuelle Bedingungen und Änderungen zu klären.",
      approach3: "Ausführung mit Fokus auf sicheren Zugang, geordnetes Kabelmanagement und mechanisch korrekte Montage aller Komponenten.",
      approach4: "Abschließende Kontrolle der Arbeiten, strukturierte Fotodokumentation und eine kurze Zusammenfassung etwaiger offener Punkte.",

      safetyTitle: "Sicherheit und Qualifikation",
      safetyIntro: "Arbeiten in der Höhe an Telekommunikationsstrukturen erfordern eine Kombination aus Elektro-Qualifikation, PSAgA-Schulung und Kenntnis der relevanten Arbeitsschutzvorschriften. Diese Bereiche verstehen wir als Gesamtpaket und nicht nur als zusätzliche Bürokratie.",
      safety1: "Elektro-Qualifikation nach NV 194/2022 §6/§7 (CZ) als Grundlage für Tätigkeiten an betriebenen Telekommunikationsanlagen innerhalb der EU.",
      safety2: "Regelmäßige Schulungen für Arbeiten in der Höhe und PSAgA, inklusive Rettungskonzepte, die auf Masten und Dachstandorte zugeschnitten sind.",
      safety3: "Interne Abläufe und Nachweise zu Gefährdungsbeurteilungen, Rettungsplänen, PSA-Kontrollen sowie grundlegenden Werkzeug- und Gerätekontrollen.",
      safety4: "Bevorzugt werden eingespielte, stabile Teams anstelle ständig wechselnder Crews.",

      contactTitle: "Kontakt & Zusammenarbeit",
      contactIntro: "Für die Zusammenarbeit bei Rollout-, Modernisierungs- oder Serviceprojekten nutzen Sie bitte den direkten Kontakt unten. Am effizientesten arbeiten wir mit klar definiertem Leistungsumfang, realistischen Zeitplänen und langfristiger technischer Zusammenarbeit.",
      ...
      contactRoleLine: "Patrik Budinský – Inhaber, Geschäftsführer und technischer Leiter",
    ...
    kli: {
      ...
      approachIntro: "nab, Qam Qu' je De' naQ wa' mIw wIchenmoH; QumwI' Sovbej nuDevwI'.",
      approach1: "Qu' taghpa' He, HeghmoH je De' poQlu'bogh wInabchu'.",
      approach2: "taghpa' QumHom, ghu' DaHjaj wIja'chu' je chay' choHta'.",
      approach3: "QaptaHvIS Qam He ngeD, SIrghmey naQ je DuQchu' wItI'.",
      approach4: "rInDI' mIllogh De' naQ wIqon je Dochmeyvo' potlh wI'ang.",

      safetyTitle: "Qan je laHmey",
      safetyIntro: "Qam Qu' telecom qachDaq: rope-access, OOPP, HoS QeD je wa' ghom. chut Qan je laHmey 'ay' neH 'oHbe'; Qu'Daj naQ 'oH.",
      safety1: "NV 194/2022 §6/§7 pat wIlo' HoS Qu'meyDaq EUDaq QapmeH.",
      safety2: "PSAgA / Qam Qeq pIj, mastmey je letlh qachmeyDaq toD mIw le'.",
      safety3: "Qan nabmey, toD nabmey, OOPP nuD je jan nuD tetlhmey wIghaj.",
      safety4: "ghom tIq wImaS; ghommey tamHa'chu'bogh maSbe'.",

      contactTitle: "Qum & malja'",
      contactIntro: "rollout, tI'ghach, Qapqa'meH malja' De' DaneHchugh, Qum De'vam yIlo'. Qu' nap, poH nap, ta tIq maS.",
      contactBilling: "Huch QaymeH Czech s.r.o. (EU VAT). nabmey DaneHchugh wIqeSlaH.",
      contactRoleLine: "Patrik Budinský – Owner, joHwI' je HoS QeD DevwI'",
